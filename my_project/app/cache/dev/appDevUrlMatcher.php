    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (preg_match('#^/blog/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_show')), array (  '_controller' => 'My\\BlogBundle\\Controller\\DefaultController::showAction',));
            }

            // blog_delete
            if (preg_match('#^/blog/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_delete')), array (  '_controller' => 'My\\BlogBundle\\Controller\\DefaultController::deleteAction',));
            }

            // blog_edit
            if (preg_match('#^/blog/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'blog_edit')), array (  '_controller' => 'My\\BlogBundle\\Controller\\DefaultController::editAction',));
            }
