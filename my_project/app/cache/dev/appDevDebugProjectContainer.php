...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'blogsymfony2', 'user' => 'blogsymfony2', 'password' => 'blogsymfony2', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/My/BlogBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Blogger/BlogBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'My\\BlogBundle\\Entity');
        $c->addDriver($b, 'Blogger\\BlogBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('MyBlogBundle' => 'My\\BlogBundle\\Entity', 'BloggerBlogBundle' => 'Blogger\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_23390217ca2e0bc777fcacefb75a5be28f5a1f874d0481f520576c449d0d9149');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('masa.tp@gmail.com');
        $a->setPassword('mkqa050429');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/My/BlogBundle/Resources/views'), 'MyBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d8e4def62433243d113610727e27ffde3');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55ee63e70b9a21.24440590')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'masa.tp@gmail.com',
            'mailer_password' => 'mkqa050429',
            'secret' => 'd8e4def62433243d113610727e27ffde3',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd8e4def62433243d113610727e27ffde3',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'masa.tp@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'mkqa050429',
